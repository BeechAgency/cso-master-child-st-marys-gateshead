# St Mary's Catholic College, Gateshead Child Theme

This is the child theme for St Mary's Catholic College, Gateshead, built on top of the [CSO Master Theme](https://github.com/BeechAgency/cso-master). It customizes the visual identity of the school website while leveraging the core functionality of the diocesan master theme.
...
- **Custom Typography**: Tailored font selections to match the St Mary's identity.
...
- **Repository**: `cso-master-child-st-marys-gateshead`
...
3. **Create Git Tag**: Create a tag that matches the version number exactly.
   ...
   ```
4. **GitHub Release**: 
   - Go to the [GitHub Repository](https://github.com/BeechAgency/cso-master-child-st-marys-gateshead/releases).
